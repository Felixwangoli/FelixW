    ...
    {image && (
      <img 
        ...
        onError={(e) => {
          ...
          e.target.src = '/placeholder-image.jpg'; // Ensure this placeholder exists
        }}
      />
    )}
  ...
  const blogPosts = [
    {
      ...
      date: "2024-03-15",
      content: "Artificial Intelligence is reshaping the field of economics... Further discussion on the topic...",
